...
public class ProjectController {
    ...
    public ResponseEntity<StatsDTO> getStats() {
        long totalProjects = projectService.getTotalApprovedProjects();
        long totalPendingProjects = projectService.getTotalPendingProjects();
        long totalUsers = projectService.getUsersCount();
        long totalLikes = projectService.getTotalLikes();
        long totalViews = projectService.getTotalViews();
        StatsDTO stats = new StatsDTO(totalProjects, totalPendingProjects, totalUsers, totalLikes, totalViews);
